...
- The iPhone 11 simulator proves the 414-point portrait layout and top-level Today-to-Plan navigation, retaining screenshot evidence for visual inspection. Planner value rules are verified in deterministic native logic tests. The iOS 26 CI simulator may use a resizable scene height and cannot reliably inspect controls inside modal Forms.
